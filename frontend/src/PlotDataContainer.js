                ...
                <div style={{flexGrow: 1}}>
                    ...
                    >
                        <TextField item
                                   ...
                                   onChange={e => this.changeState({t_min: parseFloat(e.target.value)})}
                                   InputLabelProps={{
                                       shrink: true,
                                   }}
                        />
                        <TextField item
                                   ...
                                   onChange={e => this.changeState({t_max: parseFloat(e.target.value)})}
                                   InputLabelProps={{
                                       shrink: true,
                                   }}
                        />
                        <TextField item
                                   ...
                                   onChange={e => this.changeState({t_steps: parseFloat(e.target.value)})}
                                   InputLabelProps={{
                                       shrink: true,
                                   }}
                        />
